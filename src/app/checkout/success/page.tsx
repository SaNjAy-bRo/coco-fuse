            ...
            <div className="container mx-auto px-6 max-w-3xl relative z-10 text-center">
                ...
                >
                    <p className="text-xl md:text-2xl font-body text-gray-500 mb-12 max-w-xl mx-auto leading-relaxed">
                        Hey there, legend. Your <strong className="text-accent-premium">{flavorData ? flavorData.name : "CocoFuse"}</strong> order has been placed and is being prepped for shipment. Let's get hydrated!
                    </p>
