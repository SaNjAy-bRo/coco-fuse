        ...
        >
            ...
            >
                <h2 className="text-[2.75rem] sm:text-5xl md:text-8xl lg:text-[7.5rem] font-heading font-black italic text-[#111111] tracking-tighter uppercase leading-[0.85]">
                    FUSE YOUR DAY WITH <span className="block mt-2 drop-shadow-md pr-0 md:pr-4"><span className="text-[#39FF14]">COCO</span><span className="text-[#3AB6FD]">FUSE.</span></span>
                </h2>
