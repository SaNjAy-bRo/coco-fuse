...
export default function FoundersSection() {
    const founders = [
        ...
        },
        {
            ...
            desc: "The guy who said <span className=\"font-wedges not-italic whitespace-nowrap\"><span className=\"text-[#7ED956]\">COCO</span><span className=\"text-[#3AB6FD]\">FUSE.</span></span> cannot look, taste, or BE boring. He brings the bold experimentation, insane combinations, and the jazzy personality.",
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <h3 className="text-2xl md:text-4xl font-heading font-black text-accent-premium uppercase tracking-widest flex flex-col md:flex-row items-center justify-center gap-4">
                        ...
                        <span>Balance</span>
                        <span className="text-accent-watermelon">=</span>
                        <span className="font-wedges not-italic tracking-normal text-5xl md:text-6xl"><span className="text-[#7ED956]">COCO</span><span className="text-[#3AB6FD]">FUSE.</span></span>
                    </h3>
                </motion.div>
            </div>
        </section>
