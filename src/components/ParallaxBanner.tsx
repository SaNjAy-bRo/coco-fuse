...
export default function ParallaxBanner() {
    ...
    // Use raw scroll progress — avoids spring JS overhead on mobile
    ...
    const cards = [
        {
            ...
            art: (
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="absolute w-48 h-48 bg-accent-mango/30 rounded-full blur-[40px]" />
                    <div className="absolute w-72 h-72 border-[2px] border-accent-mango/30 rounded-full" />
        ...
        },
        {
            ...
            art: (
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="absolute w-48 h-48 bg-primary-green/30 rounded-full blur-[40px]" />
                    <svg className="absolute w-full h-full text-primary-green/20" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <path d="M0,50 Q25,30 50,50 T100,50 L100,100 L0,100 Z" fill="currentColor" />
                        <path d="M0,60 Q25,40 50,60 T100,60 L100,100 L0,100 Z" fill="currentColor" className="opacity-60" />
                    </svg>
                    <svg className="absolute w-40 h-40 text-primary-green drop-shadow-[0_0_30px_rgba(126,217,86,1)]" viewBox="0 0 24 24" fill="currentColor">
        ...
        },
        {
            ...
            art: (
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="absolute w-48 h-48 bg-primary-blue/30 rounded-full blur-[40px]" />
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_20%,#050505_100%),linear-gradient(rgba(58,182,253,0.2)_2px,transparent_2px),linear-gradient(90deg,rgba(58,182,253,0.2)_2px,transparent_2px)] bg-[size:100%_100%,60px_60px,60px_60px]" />
        ...
        },
        {
            ...
            art: (
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="absolute w-48 h-48 bg-accent-watermelon/30 rounded-full blur-[40px]" />
                    <svg className="absolute w-full h-full text-accent-watermelon/20" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <path d="M50,100 Q40,70 50,40 T50,0 Q60,30 50,60 T50,100 Z" fill="currentColor" />
                    </svg>
